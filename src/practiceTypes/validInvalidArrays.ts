...
const validInvalidArraysBank: ArrayJudgmentSeed[] = [
  ...
  {
    description:
      'This arrangement has 4 equal rows with 3 dots in each row. Is it a true array?',
    correctAnswer: 'Yes, it is an array',
  ...
  {
    description:
      'This arrangement has 5 equal rows with 2 dots in each row. Is it a true array?',
    correctAnswer: 'Yes, it is an array',
  ...
  {
    description:
      'This arrangement has gaps that make the rows uneven. Is it a true array?',
    correctAnswer: 'No, it is not an array',
  ...
  {
    description:
      'This arrangement has 2 equal rows with 6 dots in each row. Is it a true array?',
    correctAnswer: 'Yes, it is an array',
  ...
  {
    description:
      'This arrangement has columns that do not line up. Is it a true array?',
    correctAnswer: 'No, it is not an array',
  ...
  {
    description:
      'This arrangement has 3 equal rows with 5 dots in each row. Is it a true array?',
    correctAnswer: 'Yes, it is an array',
  ...
  {
    description:
      'This arrangement has 6 equal rows with 2 dots in each row. Is it a true array?',
    correctAnswer: 'Yes, it is an array',
  ...
  {
    description:
      'This arrangement has scattered dots with no equal rows. Is it a true array?',
    correctAnswer: 'No, it is not an array',
