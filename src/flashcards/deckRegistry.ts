...
const zeroIdentityCards: Flashcard[] = [
  ...
  mathFactCard("zero-one-2", "3 × 0 = ?", "0", "Any number multiplied by 0 equals 0.", "Zero Rule"),
  mathFactCard(
    "zero-one-3",
    "4 × 1 = ?",
    "4",
  ...
  mathFactCard("zero-one-4", "7 × 1 = ?", "7", "One group of 7 makes 7.", "Identity Rule"),
  mathFactCard("zero-one-5", "8 × 0 = ?", "0", "Eight groups of zero makes 0.", "Zero Rule"),
  mathFactCard("zero-one-6", "1 × 9 = ?", "9", "One group of 9 makes 9.", "Identity Rule"),
  mathFactCard(
    "zero-one-7",
    "6 × 1 = ?",
    "6",
  ...
  mathFactCard("zero-one-8", "5 × 0 = ?", "0", "Five groups of zero makes 0.", "Zero Rule"),
  {
    id: "zero-one-9",
    cardType: "vocabulary",
    prompt: "product",
  ...
  mathFactCard("zero-one-10", "9 × 1 = ?", "9", "Nine groups of 1 makes 9.", "Identity Rule"),
];
...
const objectGroupsCards: Flashcard[] = [
  mathFactCard(
    ...
    "3 × 1 = ?",
    "3",
    "Three groups with 1 object in each group makes 3.",
    "Object Groups",
  ),
  mathFactCard(
    "object-groups-2",
    "4 × 0 = ?",
    "0",
    "Four groups with 0 objects in each group makes 0.",
    "Object Groups",
  ),
  mathFactCard(
    "object-groups-3",
    "2 × 5 = ?",
    "10",
    "Two groups with 5 objects in each group makes 10.",
    "Object Groups",
  ),
  mathFactCard(
    "object-groups-4",
    "5 × 3 = ?",
    "15",
    "Five groups with 3 objects in each group makes 15.",
    "Object Groups",
  ),
  mathFactCard(
    "object-groups-5",
    "6 × 1 = ?",
    "6",
    "Six groups with 1 object in each group makes 6.",
    "Object Groups",
  ),
  mathFactCard(
    "object-groups-6",
    "7 × 0 = ?",
    "0",
    "Seven groups with 0 objects in each group makes 0.",
    "Object Groups",
  ),
];
...
export const flashcardCatalogCategories: FlashcardCatalogCategory[] = [
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for Kindergarten decks. More decks will appear here as the curriculum grows.",
    icon: "K",
  ...
  },
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for 1st grade decks. More decks will appear here as the curriculum grows.",
    icon: "1",
  ...
  },
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for 2nd grade decks. More decks will appear here as the curriculum grows.",
    icon: "2",
  ...
  },
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for 4th grade decks. More decks will appear here as the curriculum grows.",
    icon: "4",
  ...
  },
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for 5th grade decks. More decks will appear here as the curriculum grows.",
    icon: "5",
  ...
  },
  {
    ...
    eyebrow: "By Grade",
    description:
      "A focused shelf for 6th grade decks. More decks will appear here as the curriculum grows.",
    icon: "6",
  ...
  },
  {
    ...
    eyebrow: "By Unit",
    description:
      "All flashcard decks connected to Unit 1, including lesson decks and mixed unit review.",
    icon: "🌱",
  ...
  },
  {
    ...
    eyebrow: "By Skill",
    description:
      "A skill shelf for rules and properties. More decks will appear here as lessons grow.",
    icon: "🛡️",
    accentClass: "from-[#F8FBFB] to-[#E9F7F8]",
  },
  {
  ...
  },
  {
    ...
    eyebrow: "By Skill",
    description:
      "A skill shelf for targeted review. More decks will appear here as progress tracking grows.",
    icon: "🎯",
    accentClass: "from-[#FCE9E5] to-[#FED9B7]",
  },
  {
    ...
    eyebrow: "By Skill",
    description:
      "A skill shelf for challenge decks. More decks will appear here as challenge content grows.",
    icon: "🏆",
    accentClass: "from-[#FFF8E9] to-[#FDFCDC]",
  },
];
...
export function getFlashcardCatalogCategory(
  ...
  return (
    flashcardCatalogCategories.find(
      (category) => category.categoryType === categoryType && category.categoryId === categoryId,
    ) ??
    flashcardCatalogCategories.find(
