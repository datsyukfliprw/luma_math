...
export type FlashcardCardType =
  "math_fact" | "vocabulary" | "rule" | "visual_model" | "mistake_review";

export type FlashcardCategory = "lesson" | "grade" | "unit" | "skill";

export type FlashcardDeckKind =
  "math_facts" | "vocabulary" | "rules" | "visual_models" | "mistake_review" | "challenge";
