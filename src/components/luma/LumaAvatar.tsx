...
export type LumaState =
  "idle" | "sleepy" | "happy" | "thinking" | "charging" | "charged" | "celebrate" | "proud";
...
function LumaAvatar({
  ...
  return (
    <div className="flex items-center gap-4">
      <div className={`relative flex ${sizeClass} shrink-0 items-center justify-center`}>
        <div className="absolute inset-3 rounded-full bg-[#FEF3D9] blur-xl" />

        {(state === "charged" || state === "celebrate" || state === "charging") && (
        ...
        <div className="pointer-events-none absolute -right-1 top-3 text-lg text-[#F7B733]">✦</div>

        <div className="pointer-events-none absolute bottom-4 left-2 text-sm text-[#00AFB9]">✦</div>
      </div>
