...
function QuickCheckPage({ starName }: QuickCheckPageProps) {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-base font-bold leading-relaxed text-[#275875]">
                Power up {starName || "Luma"} with 3 quick math puzzles.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 grid items-center gap-4 lg:grid-cols-[auto_1fr_auto]">
            ...
            >
              ...
              <h3 className="mt-1 text-2xl font-black leading-tight text-[#073B5A]">
                Luma charge animation
              </h3>

              <p className="mt-2 max-w-[420px] text-sm font-bold leading-relaxed text-[#275875]">
                This will become a compact Rive scene where Luma reacts to each
                correct answer and fills one charge star at a time.
              </p>
            </div>
        ...
        >
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-2 text-2xl font-black text-[#073B5A]">
              {Array.from({ length: currentQuestion.visualGroups }).map(
                (_, groupIndex) => (
          ...
          {hasAnswered && (
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                {isCurrentCorrect &&
                  currentQuestionIndex < quickCheckQuestions.length - 1 && (
                    <button
                      type="button"
