...
export const lesson3: LessonExperience = {
  ...
  quickCheck: {
    ...
    questions: [
      ...
      {
        id: "g3-u1-w1-d3-qc-2",
        prompt: "Maya says 18 is a factor in 3 × 6 = 18. Is Maya correct?",
        equationStart: "3 × 6 = 18",
        ...
        tipTitle: "Find the factors",
        tipText: "Factors are the numbers being multiplied.",
        hint: "In 3 × 6 = 18, 3 and 6 are factors. 18 is the product.",
        success: "Correct! 3 and 6 are factors; 18 is the product.",
        visualGroups: 0,
        visualCount: 0,
      },
      {
